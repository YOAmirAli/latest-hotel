              ...
              <form onSubmit={handleSubmit} className="mt-5 space-y-3.5">
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 bg-white border border-cyan-200 focus:border-cyan-500 focus:ring-2 focus:ring-cyan-100/80 rounded-xl outline-none text-sm text-gray-900 font-medium placeholder:text-gray-300 transition-all"
                  />
                </div>
                ...
                <div className="relative group">
                  ...
                  <div className="relative">
                    <input
                      ...
                      minLength={6}
                      placeholder="••••••••"
                      className="w-full px-4 py-2.5 bg-white border border-cyan-200 focus:border-cyan-500 focus:ring-2 focus:ring-cyan-100/80 rounded-xl outline-none text-sm text-gray-900 font-medium placeholder:text-gray-300 transition-all pr-10"
                    />
                    <button
                      type="button"
